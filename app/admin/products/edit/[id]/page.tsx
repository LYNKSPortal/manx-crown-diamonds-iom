...
export default function EditProductPage({ params }: { params: { id: string } }) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/admin/products" className="text-diamond-blue hover:underline">
            Back to Products
          </Link>
        </div>
      </div>
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Product updated successfully! (This is a demo - in production, this would save to a database)');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-8">
          <h2 className="text-2xl font-serif font-bold text-diamond-blue mb-6">Edit Product Information</h2>
